...
class ReceiptTemplate implements TemplateInterface
{
	...
	public function setAdress(string $street_1,string $street_2,string $city, string $postal_code, string $state, string $country)
	{
		$this->address = [
		'street_1' => $street_1,
		'street_2' => $street_2,
	...
	public function setSummary(float $totoal_cost, float $subtotal = null, float $shipping_cost = null, float $total_tax = null)
	{
		$this->summary = [
		'subtotal' => $subtotal,
